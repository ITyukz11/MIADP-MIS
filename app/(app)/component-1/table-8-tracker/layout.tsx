...
import MultiSelectFilterRegion from "../components/filters/table8/MultiSelectFilterRegion";
import MultiSelectFilterCommodities from "../components/filters/table8/MultiSelectFilterCommodities";
import MultiSelectFilterInfraEntrep from "../components/filters/table8/MultiSelectFilterInfraEntrep";
import MultiSelectFilterValidated from "../components/filters/table8/MultiSelectFilterValidated";
import MultiSelectFilterConceptNote from "../components/filters/table8/MultiSelectFilterCN";
...
export default function Table8Layout({ children }: ActivitiesLayoutProps) {
  const { refetchAdPlanTable8 } = useADPlanTable8Data();
