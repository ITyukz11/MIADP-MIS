...
export function AddNewDocsDialog({ open, setClose }: AddNewDocsFormProps) {
  ...
  const routeTypes = ["Incoming", "Outgoing"];
    ...
    <Dialog open={open} onOpenChange={setClose}>
      <DialogContent className="max-w-[750px] w-full overflow-y-auto scrollbar-thin max-h-[95vh] rounded-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Please encode the document here and ensure to submit it once
            completed.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          ...
          >
            <div className="grid grid-cols-3 gap-2">
              <Label>
                No: <Badge variant={"secondary"}>01</Badge>
              </Label>
              <Label>
            ...
            <DialogFooter className="flex justify-between">
              <Button typeof="submit" tabIndex={9} disabled={loading}>
