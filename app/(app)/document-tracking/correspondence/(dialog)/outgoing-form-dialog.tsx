...
export function OutgoingFormDialog({ open, setClose }: OutgoingFormProps) {
  ...
  const onSubmit = async (
    values: z.infer<typeof CorrespondenceOutgoingSchema>
  ) => {
    ...
    <Dialog open={open} onOpenChange={setClose}>
      <DialogContent className="max-w-[750px] w-full overflow-y-auto scrollbar-thin max-h-[95vh] rounded-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Please encode your outgoing form here and ensure to send it once
            completed.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          ...
          >
            <div className="grid grid-cols-3 gap-2">
              <Label>
                No: <Badge variant={"secondary"}>DTS-O-01</Badge>
              </Label>
              <Label>
                ...
                <FormItem className="w-full col-span-2">
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      placeholder="Type your particulars here."
                    />
                  </FormControl>
                </FormItem>
              )}
