            ...
            <div className='flex flex-row flex-wrap justify-center gap-2 md:justify-between'>
                ...
                <Card className='flex flex-row gap-2 w-full shadow-none'>
                    <CardContent className='flex items-center justify-center md:justify-between gap-2 w-full p-4 flex-wrap'>
                        ...
                        <Link href="/document-tracking" className={cn(buttonVariants(), "rounded-[6px] xs:w-[200px] md:w-fit flex flex-row gap-1 items-center justify-center overflow-hidden text-xs lg:text-sm")}>
                                <Home size={20} />  Home
                            </Link>
                            ...
                            <Link href="/document-tracking/procurement" className={cn(buttonVariants({ variant: 'secondary' }), "rounded-[6px] xs:w-[200px] md:w-fit flex flex-row gap-1 items-center justify-center overflow-hidden text-xs lg:text-sm")}>
                                <Package size={20} />  Procurement
                            </Link>
                            <Link href="/document-tracking/disbursement" className={cn(buttonVariants({ variant: 'secondary' }), "rounded-[6px] xs:w-[200px] md:w-fit flex flex-row gap-1 items-center justify-center overflow-hidden text-xs lg:text-sm")}>
