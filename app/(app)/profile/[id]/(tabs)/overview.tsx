    ...
    <Card className="w-full px-4 shadow-md">
      <CardHeader>
        <CardTitle className="text-lg font-semibold">
          Overview <Label className="text-destructive">{dataError}</Label>
        </CardTitle>
        <CardDescription>
          A summary of your recent activities and participation within the MIADP
          MIS system.
        </CardDescription>
      </CardHeader>
        ...
        <Card className="hover:cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-900">
          ...
          <CardContent onClick={OpenUnderDevDialog}>
            ...
            <p className="text-xs text-muted-foreground">
              {dataLoading ? "" : "+20.1% from last month"}
            </p>
          </CardContent>
        </Card>
        <Card className="hover:cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-900">
          ...
          <CardContent onClick={OpenUnderDevDialog}>
            <div className="text-2xl font-bold">
              {dataLoading ? (
                ...
                encodedActivityCount
              )}
            </div>
            <p className="text-xs text-muted-foreground">
              {dataLoading ? "" : "+7.9% from last month"}
            </p>
          </CardContent>
        </Card>
      </CardContent>
