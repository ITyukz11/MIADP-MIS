      ...
      pendinguser(values).then((data) => {
        ...
        setTimeout(() => {
          if (!data.error) {
            toast({
              title: "Registration",
              description: "Please contact PSO for approval",
              duration: 10000,
              action: (
  ...
  return (
    <div className="w-full justify-center flex flex-col">
      {/* <CardWrapper
                ...
                showSocial> */}
      <Header
        label="Enter your credentials below to register"
        title="Sign Up"
      />
      <Form {...form}>
        <form
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-row gap-2 flex-wrap justify-center items-center">
              ...
              <div className="mt-auto gap-2 flex flex-col w-full">
                <FormLabel className="flex flex-row">
                  Middle name <Label className="font-light"> (optional)</Label>
                </FormLabel>
